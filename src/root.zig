...
const bounds = @import("mesh/bounds.zig");
const clip = @import("animation/clip.zig");
const hierarchy = @import("animation/hierarchy.zig");
const node_animation = @import("animation/node.zig");
const skeleton = @import("animation/skeleton.zig");
const trs = @import("trs.zig");
...
pub const MaterialInfo = material.MaterialInfo;
...
pub const Filter = sampler.Filter;
pub const MipmapMode = sampler.MipmapMode;
pub const AddressMode = sampler.AddressMode;

pub const Vec3 = vertex.Vec3;
pub const Vertex3D = vertex.Vertex3D;
pub const Bounds = bounds.Bounds;
pub const Animation = clip.Animation;
pub const AnimationChannel = clip.Channel;
pub const AnimationTrack = clip.Track;
pub const Keyframe = clip.Keyframe;
pub const Interpolation = clip.Interpolation;
pub const TargetPath = clip.TargetPath;
pub const WeightTrack = clip.WeightTrack;
pub const Slot = hierarchy.Slot;
pub const no_parent = hierarchy.no_parent;
pub const NodeTemplate = node_animation.Template;
pub const NodeAnimator = node_animation.Animator;
pub const SkeletonTemplate = skeleton.Template;
pub const SkeletonPose = skeleton.Pose;
pub const composeTransform = trs.composeTransform;
pub const Mesh = mesh.Mesh;
pub const MeshUpload = mesh.Upload;
pub const MorphUpload = mesh.MorphUpload;
pub const Aabb = bounds.Aabb;
pub const Sphere = bounds.Sphere;
pub const VertexStreams = vertex.VertexStreams;
