...
const sampler = @import("object/sampler.zig");
...
const transfer = @import("staging/transfer.zig");
...
pub const MaterialData = materials.MaterialData;
pub const MaterialStorage = materials.MaterialStorage;
pub const MaterialTextureSlot = materials.TextureSlot;
pub const MaterialArrayBindings = materials.bindings;
...
const ui = @import("pass/ui.zig");
pub const Ui = ui;
pub const UiPass = ui.UiPass;
pub const UiShader = ui.Shader;
pub const UiCapacity = ui.Capacity;
pub const UiRegistry = ui.Registry;
pub const UiPushConstants = ui.PushConstants;
pub const ui_bindings = ui.bindings;
pub const uiVertexInput = ui.vertex_input;
pub const uiIndexType = ui.index_type;
pub const uiPushConstantRange = ui.push_constant_range;
pub const uiSampledLayout = ui.sampled_layout;
